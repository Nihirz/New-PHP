...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  <strong>SUCCESFULL!</strong> Your email  and password has been submited seccessfully
 ...
 //SUBMIT THIS FORM... TO THE DATABASE..
?>


  <div class="container mt-5">
    <form action="/phpcwh/get_post.php" method="post">
  <div class="mb-3">
